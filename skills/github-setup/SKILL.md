...
```
Godkjenn med nøkkelring-passordet (Mac-passordet) når du blir bedt om det — det vises ikke mens du skriver. Kjør deretter `eval "$(/opt/homebrew/bin/brew shellenv)"` for å aktivere det.
